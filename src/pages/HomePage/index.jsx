...
import { MdOutlineLuggage, MdOutlineModeOfTravel } from "react-icons/md";
import {
  BsAirplane,
  BsCreditCardFill,
  BsFillBookmarksFill,
  ...
  return (
    <div className="relative">
      ...
      <div className="lg:mt-52 mt-72">
        ...
        <div className="px-8 lg:px-24 my-16 lg:pb-20 pb-0">
          ...
          <div className="mt-10">
            <div className="flex justify-between gap-x-10 items-center flex-wrap gap-y-10">
              <Fade forever={true} duration={1000} delay={200}>
        ...
        {/* Why choose us? */}
        <div className="px-8 lg:px-32 mt-32 overflow-hidden text-white bg-shuttlelanePurple min-h-[90vh] py-20 relative">
          <div className="absolute overflow-hidden top-0 left-0 w-full h-full">
