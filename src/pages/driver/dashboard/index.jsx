...
function DriverDashboardHomePage() {
  const { isLoading, token, driver, upcomingBookings } = useSelector(
    (store) => store.driver
  );
                ...
                <div className="flex xl:flex-row flex-col gap-y-5 gap-x-5">
                  ...
                  <div className="xl:w-[70%] w-full">
                    ...
                    <div className="mt-11 w-full">
                      <p className="font-medium">Assigned Jobs (2)</p>
                          ...
                          <div className="flex flex-row items-center gap-x-1">
                            ...
                            <div className="flex flex-col">
                              ...
                              <small className="max-w-sm">
                                Hello Emmanuel, you have been assigned to a new
                                booking with pickup location at 12 Olowu street,
                                Ikeja
                              </small>
                            </div>
                          </div>
                        ...
                        <div className="flex h-28 p-3 justify-between items-center allRoundBoxShadow bg-white rounded-lg w-full">
                          <div className="flex flex-row items-center gap-x-1">
                            ...
                            <div className="flex flex-col">
                              ...
                              <small className="max-w-sm">
                                Hello Emmanuel, you have been assigned to a new
                                booking with pickup location at Sheraton Hotels,
                                Victoria Island
                              </small>
                            </div>
                          </div>
