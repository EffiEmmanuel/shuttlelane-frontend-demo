...
function AboutPage() {
  ...
  return (
    <div className="relative bg-white">
      ...
      {isMenuHidden && (
        <Fade duration={300}>
          <div
            ...
            className="fixed flex p-5 justify-center items-center z-[80] bottom-10 right-10 h-auto lg:w-[25%] md:w-[50%] w-[70%]"
          >
            <div
              onMouseOver={() => setIsMenuHidden(true)}
              onMouseOut={() => setIsMenuHidden(false)}
      ...
      {/* About Shuttlelane */}
      <div
        className="px-8 relative lg:px-24 py-32 pt-44 h-[80vh] flex items-center justify-center experienceBg"
        ref={howItWorksRef}
      >
      ...
      <div className="" ref={moreAboutUsRef}>
        ...
        <div className="flex items-center flex-col md:flex-row text-center md:text-left">
          <Fade duration={500}></Fade>
          <div className="flex justify-center items-center bg-shuttlelaneGold bg-opacity-90 text-shuttlelaneBlack h-[150px] p-5 gap-y-5 lg:w-1/3 w-full">
            <p className="text-md">
          ...
          <Fade duration={500} delay={100}>
            <div className="flex justify-center items-center bg-[#F7F6FF] bg-opacity-90 text-shuttlelaneBlack h-[150px] p-5 gap-y-5 lg:w-1/3 w-full">
              <p className="text-md">
          ...
          <Fade duration={500} delay={200}>
            <div className="flex justify-center items-center bg-shuttlelanePurple bg-opacity-90 text-white h-[150px] p-5 gap-y-5 lg:w-1/3 w-full">
              <p className="text-md">
