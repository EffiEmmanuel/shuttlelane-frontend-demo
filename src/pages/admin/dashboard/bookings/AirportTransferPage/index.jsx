...
function AdminDashboardAirportTransferPage() {
  ...
  useEffect(() => {
    ...
    dispatch(fetchUpcomingAirportBookings(token));
  ...
  //   const [upcomingAirportTransferBookings, setUpcomingAirportTransferBookings] =
  //     useState();
  //   useEffect(() => {
  //     if (upcomingBookings) {
  //       const airportBookings = upcomingBookings?.filter(
  //         (booking) => booking?.bookingType == "Airport"
  //       );
  //       setUpcomingAirportTransferBookings(airportBookings);
  //     }
  //   }, [upcomingBookings]);
                    ...
                    <div className="flex items-baseline justify-between">
                      <div className="flex items-center gap-x-2">
                        <p className="font-medium">
                          Upcoming Airport Transfer Bookings -{" "}
                      ...
                      {!isLoading && (
                        <>
                          {upcomingBookings?.map((booking) => (
                            <div className="flex lg:w-auto w-max cursor-pointer justify-between items-baseline mb-2 pb-2 border-b-[.3px] border-b-gray-100 text-shuttlelaneBlack mt-4">
                              <p
                                onClick={() => {
                ...
                <div className="mt-11 w-full">
                  ...
                  <div className="w-full rounded-lg border-[1.3px] lg:border-[.3px] p-3 border-gray-100 h-auto">
                    <div className="flex items-baseline justify-between">
                      <div className="flex items-center gap-x-2">
                        <p className="font-medium">
                          ...
                          {airportTransferBookings?.length}
                        </p>
                        <div className="h-2 w-2 rounded-full bg-shuttlelanePurple"></div>
                      </div>
                    </div>
                    ...
                    <div className="w-full shuttlelaneScrollbarHoriz overflow-x-scroll">
                      ...
                      {!isLoading && (
                        <>
                          {airportTransferBookings?.map((booking) => (
                      ...
                      {!isLoading && airportTransferBookings?.length < 1 && (
                        <div className="flex justify-center items-center w-full">
                          <p className="text-sm">
                            There are no airport transfer bookings for now.
                          </p>
                        </div>
                      )}
                      {isLoading && (
...
export default AdminDashboardAirportTransferPage;
