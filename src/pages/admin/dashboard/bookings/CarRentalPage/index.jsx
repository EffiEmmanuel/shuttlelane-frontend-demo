...
function AdminDashboardCarRentalPage() {
  ...
  const [upcomingCarRentalBookings, setUpcomingCarRentalBookings] = useState();
  useEffect(() => {
    if (upcomingBookings) {
      const carRentalBookings = upcomingBookings?.filter(
        (booking) => booking?.bookingType == "Car"
      );
      setUpcomingCarRentalBookings(carRentalBookings);
    }
  }, [upcomingBookings]);
                ...
                <div className="w-full">
                  <div className="w-full rounded-lg border-[.3px] p-3 border-gray-100 h-auto">
                    <div className="flex items-baseline justify-between">
                      <div className="flex items-center gap-x-2">
                        <p className="font-medium">
                          ...
                          {upcomingCarRentalBookings?.length}
                        </p>
                    ...
                    <div className="overflow-x-scroll shuttlelaneScrollbarHoriz shuttlelaneScrollbar">
                      ...
                      {upcomingCarRentalBookings?.map((booking) => (
                      ...
                      {upcomingCarRentalBookings?.length < 1 && (
