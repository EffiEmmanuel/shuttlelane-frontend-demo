...
function AdminDashboardPriorityPassPage() {
  ...
  const [upcomingPriorityPassBookings, setUpcomingPriorityPassBookings] =
    useState();
  useEffect(() => {
    if (upcomingBookings) {
      const priorityPassBookings = upcomingBookings?.filter(
        (booking) => booking?.bookingType == "Priority"
      );
      setUpcomingPriorityPassBookings(priorityPassBookings);
    }
  }, [upcomingBookings]);
  ...
  return (
    <div className="">
      <Helmet>
        <title>
          Priority Pass Bookings | Shuttlelane Portal Admin Dashboard
        </title>
      </Helmet>
                ...
                <div className="w-full">
                  <div className="w-full rounded-lg border-[1.3px] lg:border-[.3px] p-3 border-gray-100 h-auto">
                    <div className="flex items-baseline justify-between">
                      <div className="flex items-center gap-x-2">
                        <p className="font-medium">
                          ...
                          {upcomingPriorityPassBookings?.length}
                        </p>
                    ...
                    <div className="overflow-x-scroll shuttlelaneScrollbarHoriz shuttlelaneScrollbar">
                      ...
                      {upcomingPriorityPassBookings?.map((booking) => (
                ...
                <div className="mt-11 w-full">
                  ...
                  <div className="w-full rounded-lg border-[1.3px] lg:border-[.3px] p-3 border-gray-100 h-auto">
                    ...
                    <div className="w-full shuttlelaneScrollbarHoriz overflow-x-scroll">
                      ...
                      {!isLoading && (
                        <>
                          {priorityPassBookings?.map((booking) => (
