...
function DriverLoginOtpForm(props) {
  // Form field
  ...
  return (
    <div className={`${!props?.isUpdateDriverAccount && "px-10 pt-10"}`}>
      <ToastContainer />
        ...
        <div className="flex flex-row items-center justify-between">
          <div>
            ...
            <p className="text-sm">
              ...
              number. Please provide that OTP in order to log in to your driver
              account
            </p>
          </div>
        </div>
...
export default DriverLoginOtpForm;
