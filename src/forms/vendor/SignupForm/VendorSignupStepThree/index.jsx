...
function VendorSignupStepThree({ isStepSix, stepThreeStates }) {
      ...
      <form className="text-shuttlelaneBlack mt-10 flex flex-col gap-y-5">
        ...
        <div className="flex flex-col gap-y-1">
          ...
          <input
            type="password"
            name="password"
            value={stepThreeStates?.password}
            onChange={(e) => stepThreeStates?.setPassword(e.target.value)}
            placeholder="********"
...
export default VendorSignupStepThree;
