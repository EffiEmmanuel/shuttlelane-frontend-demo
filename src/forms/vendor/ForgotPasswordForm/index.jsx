...
import { vendorForgotPassword } from "../../../redux/slices/vendorSlice";
...
function VendorForgotPasswordForm() {
  ...
  async function onSubmit(values, actions) {
    dispatch(vendorForgotPassword({ email: values.email }));
  }
  ...
  return (
    <div className="px-10 pt-10">
      ...
      <p className="text-sm">
        Provide your registered company email address to reset your password
      </p>
