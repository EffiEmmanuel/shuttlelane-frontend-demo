...
const DriverFirstTimeBookingEmailTemplate = ({ driverName }) => {
  return (
    <div
      style={{
    ...
    >
      ...
      >
        ...
        >
          Congratulations on accepting your first booking, {driverName}!
        </h1>
        <p style={{ color: "#333", marginBottom: "20px" }}>
          We're excited to have you on board as a driver. To ensure a safe and
