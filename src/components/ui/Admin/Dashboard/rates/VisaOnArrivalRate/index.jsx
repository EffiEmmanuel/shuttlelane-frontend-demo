...
import { FaHandHoldingDollar, FaXmark } from "react-icons/fa6";
      ...
      {!isLoading && (
        <div className="mt-5 w-full lg:overflow-x-hidden overflow-x-scroll shuttlelaneScrollbarHoriz shuttlelaneScrollbar">
          ...
          {visaOnArrivalRates?.map((visaOnArrivalRate) => (
            <div className="flex maxContent lg:max-w-full lg:min-w-full justify-between items-baseline mb-2 pb-2 border-b-[.3px] border-b-gray-100 text-shuttlelaneBlack mt-4">
              <p
