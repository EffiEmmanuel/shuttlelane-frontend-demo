  ...
  async (payload) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        return fetch(
          `https://shuttlelane-backend-demo2.onrender.com:3001/api/v1/auth/driver/signup`,
          {
            method: "POST",
            headers: {
...
export const loginDriver = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `https://shuttlelane-backend-demo2.onrender.com:3001/api/v1/auth/driver/login`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const fetchStatistics = createAsyncThunk(
  ...
  async (token) => {
    ...
    return fetch(
      `https://shuttlelane-backend-demo2.onrender.com:3001/api/v1/driver/statistics`,
      {
        headers: {
...
export const resendOTP = createAsyncThunk(
  ...
  async (payload) => {
    ...
    return fetch(
      `https://shuttlelane-backend-demo2.onrender.com:3001/api/v1/auth/verification/resend-otp`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const verifyOTP = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `https://shuttlelane-backend-demo2.onrender.com:3001/api/v1/auth/verification/verify-otp`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const updateDriver = createAsyncThunk(
  ...
  async (payload) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://shuttlelane-backend-demo2.onrender.com:3001/api/v1/drivers/update-driver/${payload?.driverId}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
...
export const resetDriverPassword = createAsyncThunk(
  ...
  async (payload) => {
    ...
    return fetch(
      `https://shuttlelane-backend-demo2.onrender.com:3001/api/v1/drivers/reset-password/${payload?.values?.driverId}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
...
export const fetchAssignedJobs = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `https://shuttlelane-backend-demo2.onrender.com:3001/api/v1/drivers/bookings/assigned/${payload?.driverId}`,
      {
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
        },
...
export const fetchBookingByReference = createAsyncThunk(
  ...
  async (bookingReference) => {
    console.log("HI");
    return fetch(
      `https://shuttlelane-backend-demo2.onrender.com:3001/api/v1/booking/get-booking-by-reference/${bookingReference}`,
      {}
    )
      .then((res) => res.json())
...
export const acceptBooking = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `https://shuttlelane-backend-demo2.onrender.com:3001/api/v1/drivers/booking/accept/${payload?.driverId}/${payload?.bookingId}`,
      {
        method: "PATCH",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const declineBooking = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `https://shuttlelane-backend-demo2.onrender.com:3001/api/v1/drivers/booking/decline/${payload?.driverId}/${payload?.bookingId}`,
      {
        method: "PATCH",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const fetchDriverEarnings = createAsyncThunk(
  ...
  async (payload) => {
    console.log("HI");
    return fetch(
      `https://shuttlelane-backend-demo2.onrender.com:3001/api/v1/drivers/earnings/${payload?.driverId}`,
      {
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
        },
...
export const fetchUpcomingJobs = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `https://shuttlelane-backend-demo2.onrender.com:3001/api/v1/drivers/bookings/upcoming/${payload?.driverId}`,
      {
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
        },
...
export const startBooking = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `https://shuttlelane-backend-demo2.onrender.com:3001/api/v1/drivers/booking/start/${payload?.driverId}/${payload?.bookingId}`,
      {
        method: "PATCH",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const endBooking = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `https://shuttlelane-backend-demo2.onrender.com:3001/api/v1/drivers/booking/end/${payload?.driverId}/${payload?.bookingId}`,
      {
        method: "PATCH",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const fetchCompletedJobs = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `https://shuttlelane-backend-demo2.onrender.com:3001/api/v1/drivers/bookings/completed/${payload?.driverId}`,
      {
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
        },
...
export const fetchOngoingJobs = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `https://shuttlelane-backend-demo2.onrender.com:3001/api/v1/drivers/bookings/ongoing/${payload?.driverId}`,
      {
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
        },
