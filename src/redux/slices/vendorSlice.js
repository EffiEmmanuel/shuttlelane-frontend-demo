...
export const signupVendor = createAsyncThunk(
  ...
  async (payload) => {
    ...
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/auth/vendor/signup`,
      {
        method: "POST",
        headers: {
...
export const loginVendor = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/auth/vendor/login`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const fetchStatistics = createAsyncThunk(
  ...
  async (token) => {
    ...
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendor/statistics`,
      {
        headers: {
...
export const resendOTP = createAsyncThunk(
  ...
  async (payload) => {
    ...
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/auth/verification/resend-otp`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const verifyOTP = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/auth/verification/verify-otp`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  async (payload) => {
    ...
    try {
      ...
      const response = await fetch(
        `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendors/update-vendor/${payload?.vendorId}`,
        {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
...
export const resetVendorPassword = createAsyncThunk(
  ...
  async (payload) => {
    ...
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendors/reset-password/${payload?.values?.vendorId}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
...
export const fetchVendorAssignedJobs = createAsyncThunk(
  ...
  async (payload) => {
    ...
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendors/bookings/assigned/${payload?.vendorId}`,
      {
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
        },
...
export const acceptBooking = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendors/booking/accept/${payload?.vendorId}/${payload?.bookingId}/${payload?.fleetId}/${payload?.driverId}`,
      {
        method: "PATCH",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const declineBooking = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendors/booking/decline/${payload?.vendorId}/${payload?.bookingId}`,
      {
        method: "PATCH",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const fetchVendorEarnings = createAsyncThunk(
  ...
  async (payload) => {
    console.log("HI");
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendors/earnings/${payload?.vendorId}`,
      {
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
        },
...
export const fetchUpcomingJobs = createAsyncThunk(
  ...
  async (payload) => {
    ...
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendors/bookings/upcoming/${payload?.vendorId}`,
      {
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
        },
...
export const startBooking = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendors/booking/start/${payload?.vendorId}/${payload?.bookingId}`,
      {
        method: "PATCH",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const endBooking = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendors/booking/end/${payload?.vendorId}/${payload?.bookingId}`,
      {
        method: "PATCH",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const fetchCompletedJobs = createAsyncThunk(
  ...
  async (payload) => {
    ...
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendors/bookings/completed/${payload?.vendorId}`,
      {
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
        },
...
export const fetchOngoingJobs = createAsyncThunk(
  ...
  async (payload) => {
    ...
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendors/bookings/ongoing/${payload?.vendorId}`,
      {
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
        },
  ...
  async (payload) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const data = await response.json();
        return fetch(
          `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendors/drivers`,
          {
            method: "POST",
            headers: {
              token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const createVendorCar = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendors/fleet`,
      {
        method: "POST",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const fetchVendorDrivers = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendors/drivers?vendorId=${payload?.vendorId}`,
      {
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
        },
...
export const fetchVendorFleet = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendors/fleet?vendorId=${payload?.vendorId}`,
      {
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
        },
...
export const updateVendorDriver = createAsyncThunk(
  ...
  async (payload) => {
    ...
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendors/drivers/${payload?.driverId}/${payload?.values?.vendor}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
...
export const updateVendorFleet = createAsyncThunk(
  ...
  async (payload) => {
    ...
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendors/fleet/update/${payload?.fleetId}/${payload?.values?.vendor}`,
      {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
...
export const deleteVendorDriver = createAsyncThunk(
  ...
  async (payload) => {
    ...
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendors/drivers/${payload?.values?.vendor}/${payload?.driverId}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
...
export const deleteVendorFleet = createAsyncThunk(
  ...
  async (payload) => {
    ...
    return fetch(
      `https://shuttlelane-backend-demo.up.railway.app:3001/api/v1/vendors/fleet/${payload?.vendorId}/${payload?.fleetId}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
