...
export const loginAdmin = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/auth/admin/login`,
      {
        method: "POST",
        headers: {
...
export const fetchStatistics = createAsyncThunk(
  ...
  async (token) => {
    ...
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/statistics`,
      {
        headers: {
...
export const createCity = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/cities`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const addAirportToCity = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/cities/add-airport`,
      {
        method: "POST",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const fetchCity = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/cities/${payload?.cityId}`,
      {
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
        },
...
export const fetchUsers = createAsyncThunk(
  ...
  async (token) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/users`,
      {
        headers: {
          token: `Bearer ${JSON.parse(token)}`,
        },
...
export const deleteUserById = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/users/delete/${payload?.userId}`,
      {
        method: "DELETE",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const fetchDrivers = createAsyncThunk(
  ...
  async (token) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/drivers`,
      {
        headers: {
          token: `Bearer ${JSON.parse(token)}`,
        },
...
export const fetchApprovedDrivers = createAsyncThunk(
  ...
  async (token) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/drivers/approved`,
      {
        headers: {
          token: `Bearer ${JSON.parse(token)}`,
        },
...
export const deleteDriverById = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/drivers/delete/${payload?.driverId}`,
      {
        method: "DELETE",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const fetchVendors = createAsyncThunk(
  ...
  async (token) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/vendors`,
      {
        headers: {
          token: `Bearer ${JSON.parse(token)}`,
        },
...
export const fetchApprovedVendors = createAsyncThunk(
  ...
  async (token) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/vendors/approved`,
      {
        headers: {
          token: `Bearer ${JSON.parse(token)}`,
        },
...
export const approveVendorAccount = createAsyncThunk(
  ...
  async (payload) => {
    ...
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/vendors/${payload?.vendorId}/account/approve`,
      {
        method: "PATCH",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const deleteVendorById = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/vendors/delete/${payload?.vendorId}`,
      {
        method: "DELETE",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const fetchEnquiries = createAsyncThunk(
  ...
  async (token) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/enquiries`,
      {
        headers: {
          token: `Bearer ${JSON.parse(token)}`,
        },
...
export const deleteEnquiryById = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/enquiries/delete/${payload?.enquiryId}`,
      {
        method: "DELETE",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const markEnquiryAsRead = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/enquiries/${payload?.enquiryId}/mark-as-read`,
      {
        method: "PATCH",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const markEnquiryAsUnread = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/enquiries/${payload?.enquiryId}/mark-as-unread`,
      {
        method: "PATCH",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const sendBulkEmail = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/broadcasts/bulk-email`,
      {
        method: "POST",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const fetchCurrencies = createAsyncThunk(
  ...
  async (token) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/currencies`,
      {
        headers: {
          token: `Bearer ${JSON.parse(token)}`,
        },
...
export const createNewCurrency = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/currencies/create-new`,
      {
        method: "POST",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const updateCurrency = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/currencies/${payload?._id}`,
      {
        method: "PUT",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const fetchRatePerMile = createAsyncThunk(
  ...
  async (token) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/booking/rate-per-mile`,
      {
        headers: {
          token: `Bearer ${JSON.parse(token)}`,
        },
...
export const setRatePerMile = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/rate-per-mile`,
      {
        method: "POST",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const fetchVisaOnArrivalRates = createAsyncThunk(
  ...
  async (token) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/visa-on-arrival-rates`,
      {
        headers: {
          token: `Bearer ${JSON.parse(token)}`,
        },
...
export const updateVisaOnArrivalRate = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/visa-on-arrival-rates/${payload?._id}`,
      {
        method: "PUT",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const fetchVisaOnArrivalBaseRates = createAsyncThunk(
  ...
  async (token) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/visa-on-arrival-rates/base`,
      {
        headers: {
          token: `Bearer ${JSON.parse(token)}`,
        },
...
export const fetchVehicleClasses = createAsyncThunk(
  ...
  async (token) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/vehicle-classes?isAdminRequest=true`,
      {
        headers: {
          token: `Bearer ${JSON.parse(token)}`,
        },
  ...
  async (payload) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        return fetch(
          `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/vehicle-classes`,
          {
            method: "POST",
            headers: {
              token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const updateVehicleClass = createAsyncThunk(
  ...
  async (payload) => {
    switch (typeof payload?.image) {
      ...
      case "string":
        return fetch(
          `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/vehicle-classes/${payload?.vehicleClassId}`,
          {
            method: "PUT",
            headers: {
              token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const fetchCars = createAsyncThunk(
  "admin/cars/getAll",
  async (token) => {
    return fetch(`shuttlelane-backend-demo.up.railway.app:3001/api/v1/cars`, {
      headers: {
        token: `Bearer ${JSON.parse(token)}`,
      },
    })
...
export const createCar = createAsyncThunk(
  ...
  async (payload) => {
    ...
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/cars`,
      {
        method: "POST",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const updateCar = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/cars/${payload?.carId}`,
      {
        method: "PUT",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const fetchPasses = createAsyncThunk(
  ...
  async (token) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/passes?isAdminRequest=true`,
      {
        headers: {
          token: `Bearer ${JSON.parse(token)}`,
        },
...
export const createPass = createAsyncThunk(
  ...
  async (payload) => {
    ...
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/passes`,
      {
        method: "POST",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const updatePass = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/passes/${payload?.passId}`,
      {
        method: "PUT",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const fetchBlogPosts = createAsyncThunk(
  ...
  async () => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/blog-posts`,
      {}
    )
      .then((res) => res.json())
  ...
  async (payload) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        return fetch(
          `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/blog-posts`,
          {
            method: "POST",
            headers: {
              token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const updateBlogPost = createAsyncThunk(
  ...
  async (payload) => {
    switch (typeof payload?.image) {
      ...
      case "string":
        return fetch(
          `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/blog-posts/${payload?.blogPostId}`,
          {
            method: "PUT",
            headers: {
              token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const adminFetchUpcomingBookings = createAsyncThunk(
  ...
  async (token) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/bookings/upcoming`,
      {
        headers: {
          token: `Bearer ${JSON.parse(token)}`,
        },
...
export const adminFetchBookingsAwaitingAssignment = createAsyncThunk(
  ...
  async (token) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/bookings/unassigned`,
      {
        headers: {
          token: `Bearer ${JSON.parse(token)}`,
        },
...
export const deleteBooking = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/booking/delete-booking/${payload?._id}`,
      {
        method: "DELETE",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const assignToJob = createAsyncThunk(
  ...
  async (payload) => {
    console.log("PAYLOAD FROM AsyncThunk:", payload);
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/assign-to-booking/${payload?.userType}/${payload?.userId}/${payload?.bookingId}`,
      {
        method: "PATCH",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const approveDriverAccount = createAsyncThunk(
  ...
  async (payload) => {
    console.log("PAYLOAD FROM AsyncThunk:", payload);
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/drivers/${payload?.driverId}/account/approve`,
      {
        method: "PATCH",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const fetchBookingByReference = createAsyncThunk(
  ...
  async (bookingReference) => {
    console.log("HI");
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/booking/get-booking-by-reference/${bookingReference}`,
      {}
    )
      .then((res) => res.json())
...
export const createAdminAccount = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/auth/admin/signup`,
      {
        method: "POST",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const fetchAdminAccounts = createAsyncThunk(
  ...
  async (token) => {
    console.log("HI");
    return fetch(`shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin`, {
      headers: {
        token: `Bearer ${JSON.parse(token)}`,
      },
    })
...
export const deleteAdminAccount = createAsyncThunk(
  ...
  async (payload) => {
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/${payload?.adminId}`,
      {
        method: "DELETE",
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
...
export const createBooking = createAsyncThunk(
  ...
  async (payload) => {
    ...
    return fetch(
      "shuttlelane-backend-demo.up.railway.app:3001/api/v1/booking",
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const calculateTotal = createAsyncThunk(
  ...
  async (payload) => {
    ...
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/booking/calculate-total?userCountry=${userCountry.data?.country_name}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const fetchPayments = createAsyncThunk(
  ...
  async (token) => {
    console.log("HI");
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/payments`,
      {
        headers: {
          token: `Bearer ${JSON.parse(token)}`,
        },
...
export const fetchPayment = createAsyncThunk(
  ...
  async (payload) => {
    console.log("HI");
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/payments/${payload?.paymentId}`,
      {
        headers: {
          token: `Bearer ${JSON.parse(payload?.token)}`,
        },
...
export const fetchAllBookings = createAsyncThunk(
  ...
  async (token) => {
    console.log("HI");
    return fetch(
      `shuttlelane-backend-demo.up.railway.app:3001/api/v1/admin/bookings`,
      {
        headers: {
          token: `Bearer ${JSON.parse(token)}`,
        },
